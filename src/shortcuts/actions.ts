...
export const SHORTCUT_ACTIONS: ShortcutActionMeta[] = [
  ...
  { id: 'judgment.nextImage', label: '下一张图', category: '判断台', scope: 'judgmentDesk', defaultBinding: getDefaultShortcutBinding('judgment.nextImage') },
  { id: 'judgment.exit', label: '结束重判／返回', category: '判断台', scope: 'judgmentDesk', defaultBinding: getDefaultShortcutBinding('judgment.exit') },
