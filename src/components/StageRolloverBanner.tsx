...
import { listCurrentStageLiveTrades, listStageRolloverAdvisories, listStageRolloverBlockers, shouldSurfaceStageRolloverBanner } from '@/lib/stageRollover'
...
export function StageRolloverBanner({
  ...
  if (!scheduled || !shouldSurfaceStageRolloverBanner(scheduled, currentTradingDayKeyOverride ?? currentTradingDayKey)) {
    return null
  }
  ...
  return (
    ...
    >
      ...
      <div className="stage-rollover-banner-copy">
        ...
        {blockers.length > 0 || advisoryCodes.has('planned-trades') ? <div className="stage-rollover-banner-detail">
