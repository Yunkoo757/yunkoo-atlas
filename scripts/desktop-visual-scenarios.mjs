...
export const DESKTOP_VISUAL_SCENARIOS = Object.freeze([
  ...
  Object.freeze({ id: 'paper-trades', path: '/sim', ready: '.trade-list' }),
  Object.freeze({ id: 'live-archive', path: '/live-history', ready: '.trade-list' }),
  Object.freeze({ id: 'live-history-cases', path: '/live-history?view=cases', ready: '.trade-list' }),
